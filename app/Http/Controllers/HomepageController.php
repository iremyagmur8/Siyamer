...
class HomepageController extends Controller
{
    ...
    public function index()
    {
        ...
        $cData->hakkimizda = post::where("category_id", 3)->first();
    ...
    {
        $cData = new \ArrayObject();
        $cData->hakkimizda = post::where("category_id", 3)->get();
        return view('home.hakkimizda', ['cData' => $cData]);
    }

    public function hizmetlerimiz(Request $request)
    {
        $cData = new \ArrayObject();
        $cData->hizmetlerimiz = post::where("category_id", 4)->get();
        return view('home.hizmetlerimiz', ['cData' => $cData]);
    }
